...
@freezed
class RemoteConnection with _$RemoteConnection {
  factory RemoteConnection({
    int? id,
    String? uuid,
  ...
  factory RemoteConnection.fromJson(Map<String, dynamic> json) =>
      _$RemoteConnectionFromJson(json);
}

@freezed
class RemoteTerminal with _$RemoteTerminal {
  factory RemoteTerminal({
    int? id,
    String? uuid,
    String? serialNumber,
    String? deviceId,
  ...
  factory RemoteTerminal.fromJson(Map<String, dynamic> json) =>
      _$RemoteTerminalFromJson(json);
}
